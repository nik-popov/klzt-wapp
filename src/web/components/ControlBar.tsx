...
function AccountPanel() {
  ...
  if (!data) {
    return (
      <a
        href="/api/auth/login"
        className="inline-flex items-center gap-2 rounded-md border border-neutral-300 bg-white px-3 py-2 text-sm font-medium text-neutral-900 shadow-sm hover:bg-neutral-50 dark:border-neutral-700 dark:bg-neutral-900 dark:text-neutral-100 dark:hover:bg-neutral-800"
      >
        Sign in with Google
      </a>
    );
  ...
  return (
    <div className="flex items-center gap-3">
      {user.picture ? (
        ...
        <div className="grid h-10 w-10 place-items-center rounded-full bg-neutral-200 text-sm font-semibold text-neutral-700 dark:bg-neutral-800 dark:text-neutral-200">
          {initial}
        </div>
      )}
